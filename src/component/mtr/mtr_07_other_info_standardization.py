#!/usr/bin/env python
# -*- coding:utf-8 -*-
# @FileName  :mtr_07_other_info_standardization.py.py
# @Time      :2024/12/19 14:14
# @Author    :chenwen
...
class MtrOtherInfoStandardization(TaskBaseExecutor):
    """
    ...
    def execute(self):
        ...
        self._trans_info_match('status_col', 'trans_status')
        self._trans_info_match('order_no_col', 'order_no')
        self._trans_info_match('shop_name_col', 'shop_name')
        self._trans_info_match('shop_id_col', 'shop_id')
        self._trans_info_match('order_source_col', 'order_source')
        self._trans_info_match('credit_card_col', 'if_credit_card')
        self._trans_info_match('advance_col', 'advance')
        self._remark_match()
